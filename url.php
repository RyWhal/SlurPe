...
if (isValidUrl($url_full)){	
	...
	if ($result = $mysqli->query($sql)) {
		...
		if($row[0]!=$url_short && ctype_alnum($url_short)){
			...
			$message= "<h2 style='margin-left:15%;'>Your Short URL:</h2><br><textarea class='copybox' id='copy_text'>slur.pe/$url_short</textarea><p style='width:70%; margin-left:15%; margin-right:15%;'>Copy the link above into a URL bar to go to $url_full</p>";
                ...
                <div class="container">
                        ...
                        <div class="collapse navbar-collapse">
                                <ul class="nav navbar-nav">
                                        <li class="active"><a href="http://slur.pe">Home</a></li>
